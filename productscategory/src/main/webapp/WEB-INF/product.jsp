...
<body>
<h2 class="text-xl font-semibold text-gray-800 mb-4">New Product</h2>
<a href="/" class="text-blue-500">Home</a>
<hr>
<div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
    <form:form action="/products" method="post" modelAttribute="product" cssClass="space-y-4">
        ...
        <div>
            <form:label path="price" cssClass="block text-sm font-medium text-gray-700">Price</form:label>
            <form:errors path="price"/>
            <form:input path="price" cssClass="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300"/>
        </div>
