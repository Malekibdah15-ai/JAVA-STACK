...
<div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <form:form action="/register" method="post" modelAttribute="newUser" cssClass="space-y-4">
        ...
        <div>
            ...
            <form:input path="email" cssClass="mt-1 bl  ock w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300"/>
        </div>
